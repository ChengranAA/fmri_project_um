...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\herrd\\Desktop\\LocalizerExperiment\\LocalizerExperiment.py',
...
blocks = data.TrialHandler(nReps=20.0, method='random', 
...
for thisBlock in blocks:
    ...
    for thisTrial in trials:
        ...
        store_picture1 = trials.thisTrial.get("stim_images1")
        # keep track of which components have finished
        routine_0_75sec_Face_HouseComponents = [text, image, polygon_2]
...
# completed 20.0 repeats of 'blocks'
