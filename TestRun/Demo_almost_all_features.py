...
routine_5TR_PrePeriodComponents = [waiting_TR, text]
...
while continueRoutine and routineTimer.getTime() < 30.0:
    ...
    if len (waiting_TR.keys) == 5:
                ...
                thisExp.addData('TR counter',counter_list)
                counter_list=[]
...
for thisTrial in trials:
    ...
    _Prompt1TR_allKeys = []
    # keep track of which components have finished
    PromptComponents = [text_9, Prompts, Prompt1TR]
...
, log=False)
        ...
        if Prompt1TR.status == STARTED and not waitOnFlip:
            ...
            if len(_Prompt1TR_allKeys):
                Prompt1TR.keys = _Prompt1TR_allKeys[-1].name  # just the last key pressed
                Prompt1TR.rt = _Prompt1TR_allKeys[-1].rt
    ...
    _key_resp_allKeys = []
    # keep track of which components have finished
    RestEither3or6SecsComponents = [text_2, text_10, key_resp]
    ...
    _TR_Stim1_allKeys = []
    # keep track of which components have finished
    Stimulus1Components = [StimuliTimer1, Stimuli1, TR_Stim1]
    ...
    while continueRoutine:
        ...
        if TR_Stim1.status == STARTED and not waitOnFlip:
            ...
            if len(_TR_Stim1_allKeys):
                TR_Stim1.keys = _TR_Stim1_allKeys[-1].name  # just the last key pressed
                TR_Stim1.rt = _TR_Stim1_allKeys[-1].rt
    ...
    _TR_Stim2_allKeys = []
    # keep track of which components have finished
    Stimulus2Components = [StimuliTimer2, Stimuli2, TR_Stim2]
    ...
    _TR_Stim3_allKeys = []
    # keep track of which components have finished
    Stimulus3Components = [StimuliTimer3, Stimuli3, TR_Stim3]
    ...
    _TR_Stim4_allKeys = []
    # keep track of which components have finished
    Stimulus4Components = [StimuliTimer4, Stimuli4, TR_Stim4]
    ...
    _rest_key_allKeys = []
    # keep track of which components have finished
    Rest15secsComponents = [text_8, text_15, rest_key]
